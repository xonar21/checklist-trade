...
const CHECKLIST_TEMPLATE_BLOCKS = [
  {
    ...
    blockHint:
      '🗺 Контекст рынка (The Map)\n\n' +
      'Таймфрейм: Основной — H1 (1 час), уточняющий — M15 (15 минут).\n\n' +
      'LONG / SHORT TREND (Тренд):\n\n' +
      'Сколько свечей: Последние 24–48 свечей на H1 (т.е. последние 1–2 суток).\n\n' +
      'Индикация: Визуальная «лесенка». Для лонга — каждый следующий значимый минимум (лоу) выше предыдущего. Для шорта — каждый хай ниже предыдущего.\n\n' +
      'Правило: Торгуем только «Захват» ликвидности по направлению этой лесенки.\n\n' +
      'RANGE (Боковик):\n\n' +
      'Сколько свечей: От 12 до 24 свечей на H1.\n\n' +
      'Индикация: Цена зажата в «коридоре», границы которого тестировались минимум по 2 раза сверху и снизу.\n\n' +
      'Правило: Торгуем «Отскок» от обеих границ внутрь канала.\n\n' +
      'BREAKOUT (Поджатие):\n\n' +
      'Таймфрейм: Переходим на M15.\n\n' +
      'Сколько свечей: Последние 10–15 свечей.\n\n' +
      'Индикация: Цена «прилипла» к уровню (границе боковика или тренда) и не откатывает. Свечи становятся мелкими, а лои/хаи поджимаются к линии пробоя.\n\n' +
      'Правило: Заходим на импульс в сторону пробоя, не ждем отскока.',
    groups: [
      {
        id: 'map-structure',
